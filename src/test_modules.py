...
import argparse
from modules.geometry.obstacles import generate_circle

parser = argparse.ArgumentParser(description="Test individual geometry modules")
parser.add_argument("--test", type=str, required=True, help="Specify the shape to test (circle, ellipse, etc.)")
